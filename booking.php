				...
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3><?php echo $movie['movie_name']; ?></h3>	
							...
							<?php
								$s=mysqli_query($con,"select * from showtime where showtime_id='".$_SESSION['show']."'");
								$shw=mysqli_fetch_array($s);
								
									$t=mysqli_query($con,"select * from branch where theatre='".$shw['theatre']."'");
									...
									<tr>
										...
										<td>
											<?php echo $branch['theatre'].", ".$branch['city'].",".$branch['street'];?>
										</td>
										</tr>
