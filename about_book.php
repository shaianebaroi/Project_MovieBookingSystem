							...
							<table class="table table-hover table-bordered text-center">
								...
								<thead>
										<tr>
											...
											<th class="text-center" style="font-size:16px;"><b>Hall No</b></th>
											<th class="text-center" style="font-size:16px;"><b>Category</b></th>
										</tr>
									</thead>
									<?php
									...
									<tr>
										...
										<td>	
											<?php echo substr($row[2],0,5);?>
										</td>
										<td>
											<?php echo $row['hall_no'];?>
										</td>
										<td>
											<?php 
											if($row['hall_no'] == 4 or $row['hall_no'] == 5 ){ ?>
											<p>Premium</p>
											<?php 
											}
											else{
										...
										<td>	
											<a href = "pay_check_login.php?show=<?php echo $row[0];?>&movie=<?php echo $movie['movie_id'];?>&theatre=<?php echo $row[2];?>"><button class="btn btn-default">Book Now</button></a>
										</td>
									</tr>
									</tbody>
