              ...
              <div class="nav-wrap">
                    <ul class="group" id="example-one">
                       ...
                       <li>
                          ...
                          $query=mysqli_query($con,"select * from user where u_id='".$_SESSION['user']."'");
                          $user=mysqli_fetch_array($query);?>
                          <a href="profile.php">
                          <?php echo $user['u_name'];?></a>
                          <a href="logout.php">Logout</a>
                          <?php }else{?>
                          <a href="login.php">Login</a></li>
                       <li> <a href="registration.php">Register</a><?php }?></li>
                       <li> <a href="memregister.php">Membership</a><?php ?></li>
